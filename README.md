# GlassFish-Web-App
Aplicación Web desarrollada en Java 1.8, utilizando JSP para la capa de presentación y desplegando con el servidor de aplicaciones GlassFish 5.1. Este sistema implementa un prototipo de login de usuario básico. 
